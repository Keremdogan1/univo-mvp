        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="order-first lg:order-last -mx-4 px-4 lg:mx-0 lg:px-0">
                    <div className="flex flex-row flex-nowrap items-start gap-4 overflow-x-auto pb-4 lg:pb-0 lg:flex-col lg:overflow-x-visible lg:gap-8 lg:pr-2 snap-x snap-mandatory" style={{ scrollbarWidth: 'thin' }}>
                        {/* Weekly Poll */}
                        <div className="border-4 border-black dark:border-white p-4 bg-white dark:bg-neutral-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)] transition-colors shrink-0 w-[260px] lg:w-full lg:min-w-0 snap-center">
                        ...
                        {/* Trending Topics */}
                        <div className="border-4 border-black dark:border-white p-6 bg-white dark:bg-neutral-900 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)] transition-colors shrink-0 w-[260px] lg:w-full lg:min-w-0 snap-center">
