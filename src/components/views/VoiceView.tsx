        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="order-first lg:order-last -mx-4 lg:mx-0">
                    <div className="flex flex-row flex-nowrap items-start gap-0 overflow-x-auto pb-4 pt-4 mb-4 lg:pt-0 lg:mb-0 lg:pb-0 lg:flex-col lg:overflow-x-visible lg:gap-8 lg:pr-2 snap-x snap-mandatory bg-[rgba(var(--primary-rgb),0.08)] lg:bg-transparent transition-colors duration-300" style={{ scrollbarWidth: 'none' }}>
                        {/* Weekly Poll */}
