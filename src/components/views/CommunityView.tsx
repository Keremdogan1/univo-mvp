        ...
        <div className="lg:col-span-1">
             <div className="sticky top-24">
                ...
                <div className="mt-8">
                    ...
                    <div className="border-4 border-black dark:border-white p-6 bg-white dark:bg-neutral-900 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)] transition-colors">
                        <h3 className="text-xl font-bold border-b-2 border-black dark:border-white pb-2 mb-4 font-serif uppercase tracking-tight flex items-center gap-2 dark:text-white transition-colors">
                            <Calendar size={24} className="text-primary dark:text-primary-light" />
                            Popüler
                        </h3>
                             ...
                             {POPULAR_EVENTS.map(event => (
                                <div key={event.id} onClick={() => router.push('/events/1')} className="group cursor-pointer">
                                    <div className="flex justify-between items-start mb-1">
                                         <h4 className="font-bold font-serif text-neutral-900 dark:text-neutral-100 group-hover:text-primary dark:group-hover:text-primary-light transition-colors">{event.title}</h4>
                                    ...
                                    <div className="flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-2 mb-2 group-last:border-0 group-last:mb-0 group-last:pb-0">
                                        ...
                                        <ArrowRight size={16} className="text-neutral-400 dark:text-neutral-500 group-hover:translate-x-1 group-hover:text-primary dark:group-hover:text-primary-light transition-all" />
                                    </div>
                                </div>
                             ))}
                        </div>
