...
export default async function EventDetailPage({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b-4 border-black bg-neutral-100">
        <div className="container mx-auto px-4 py-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 font-bold uppercase tracking-wider text-sm hover:underline decoration-2 underline-offset-2"
          >
            <ArrowLeft size={20} className="border-2 border-black rounded-full p-0.5" />
      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <header className="mb-10 text-center border-b-4 border-black pb-8 relative">
           <div className="flex justify-center mb-4">
              <span className="bg-black text-white px-4 py-1 font-bold uppercase tracking-widest text-sm">
                {event.category === 'event' ? 'ETKİNLİK HABERİ' : 'DUYURU'}
              </span>
           </div>
           <h1 className="text-4xl md:text-6xl font-black font-serif text-black mb-6 leading-tight uppercase">
            {event.title}
          </h1>
           <div className="flex justify-center items-center gap-4 text-sm font-bold font-serif border-t-2 border-black pt-4 w-fit mx-auto px-8">
           ...
           <div className="absolute bottom-0 left-0 bg-black text-white px-3 py-1 text-xs font-bold uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
             {/* Lead / Excerpt */}
             <div className="text-xl font-serif font-medium leading-relaxed italic border-l-4 border-neutral-300 pl-6 mb-8 text-neutral-800">
                "{event.excerpt}"
             </div>

             {/* Description Body */}
             <div className="prose prose-lg max-w-none font-serif text-neutral-900 leading-relaxed prose-headings:font-sans prose-headings:font-bold prose-headings:uppercase">
             ...
             {isPastEvent && (
                 <div className="mt-8 p-6 bg-yellow-50 border-2 border-yellow-400 rounded-lg">
                     ...
                     <p className="mb-4 text-neutral-700">Bu etkinliğe katıldıysan deneyimini paylaşabilirsin.</p>
             ...
             <div className="mt-12 pt-8 border-t-2 border-black flex items-center justify-between">
                <div>
                   ...
                   <Link href={`/community/${event.community.id}`} className="text-xl font-black font-serif hover:underline text-blue-600">
          ...
          <div className="lg:col-span-1 space-y-8">
             ...
             <div className="bg-neutral-50 border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <h3 className="text-2xl font-black font-serif uppercase mb-6 border-b-2 border-black pb-2 text-center">
                   Katılım Durumu
                </h3>
